package com.himalaya.restfulwebservice.config;
...
public class SwaggerConfig {
    ...
    private static final Contact DEFAULT_CONTACT = new Contact("Kenneth Lee", "http://joneconsulting.co.kr", "edowon@doneconsulting.co.kr");
